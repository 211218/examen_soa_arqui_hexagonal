...
import { createAlumnoController, getAllAlumnoController, addAlumnoToTutorController, addAlumnoToMateriaController } from "./dependencies";
...
alumnosRoutes.post("/AlumnoToMateria", addAlumnoToMateriaController.run.bind(addAlumnoToMateriaController));